...
export default function VisitUs() {
  return (
    <section id="visit" className="bg-[#FAF9F6] py-24 md:py-32 border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-xs uppercase tracking-[0.3em] text-[#C5A880] mb-2 block font-medium">Find Us</span>
            <SectionHeading
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center shrink-0 mt-1">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C5A880" strokeWidth="2" className="shrink-0">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-[#C5A880] text-sm font-semibold mt-2 hover:underline font-sans"
                  >
                    Get Directions
                ...
                <div>
                  ...
                  <div className="space-y-1 font-sans">
                    {siteInfo.hours.map((h) => (
                      <div key={h.day} className="flex justify-between gap-4 text-sm max-w-sm">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-[#C5A880] text-sm font-semibold hover:underline font-sans"
                  >
                    {siteInfo.phone}
                  </a>
                </div>
          ...
          <ScrollReveal delay={0.25}>
            <div className="relative rounded-xl overflow-hidden shadow-lg h-[400px] lg:h-full min-h-[400px] border border-stone-200">
              <iframe
